...
module.exports = require('@neon-rs/load').proxy({
  platforms: {
    'win32-x64-msvc': () => require('@fhe_http_js/win32-x64-msvc'),
    'darwin-x64': () => require('@fhe_http_js/darwin-x64'),
    'darwin-arm64': () => require('@fhe_http_js/darwin-arm64'),
    'linux-x64-gnu': () => require('@fhe_http_js/linux-x64-gnu')
  },
