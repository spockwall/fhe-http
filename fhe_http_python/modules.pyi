from fhe_http_python import FheValue, ProvenFheValue
...
class Fhe:
    ...
    def encrypt(self, val: SerialData, data_type: FheValue) -> SerialData: ...
    def proven_encrypt(
        self, val: SerialData, data_type: ProvenFheValue
    ) -> SerialData: ...
...
# FheValue and ProvenFheValue
def create_fhe_value_type(s: str) -> FheValue: ...
def create_proven_fhe_value_type(s: str) -> ProvenFheValue: ...
...
def decrypt_fhe_body(
    keys: dict[str, FheValue], data: dict, client_key: SerialData
) -> dict: ...
